...
public class ClasspathPackageScanner {
    ...
    private List<String> doScan(String basePackage, List<String> nameList) throws IOException {
        ...
        URL url = cl.getResource(splashPath);   //file:/D:/GIT_RES/jense-spring/beta_v1/target/classes/com/jense/spring
        ...
        for (String name : names) {
            if (isClassFile(name)) {nameList.add(toFullyQualifiedName(name, basePackage));
    ...
    public static void main(String[] args) throws Exception {
        ClasspathPackageScanner scan = new ClasspathPackageScanner("com.jense.spring");
